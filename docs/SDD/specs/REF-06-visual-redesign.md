...
| **D2 — Desktop layout** | **L1 — full-bleed**: board centered and dominant; HUD strip floats above the board; active power-ups float top-right of the board; combo and phase progress overlay bottom-left of the board. No left/right rails. | HUD canon from Number Analytics ("critical info prominently displayed"). Removes dashboard look. Aligns with US-02 and SR-01. |
